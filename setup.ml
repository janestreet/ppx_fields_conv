(* OASIS_START *)
(* DO NOT EDIT (digest: 1d44b7509ab3d711b5aa3671c1f341da) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_fields_conv";
          synopsis =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("compiler-libs", None);
                           FindlibPackage ("ppx_core", None);
                           FindlibPackage ("ppx_driver", None);
                           FindlibPackage ("ppx_type_conv", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\214+\230\022\234\018\248m\246co(\144<A\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
